...
def main2d():
    batch_size = 1
    trainloader = DataLoader(dataset=RandomDataset2d(10000, 1024, 0),
                             batch_size=batch_size, shuffle=True)
    valloader = DataLoader(dataset=RandomDataset2d(2000, 1024, 0),
                           batch_size=batch_size, shuffle=True)
    testloader = DataLoader(dataset=RandomDataset2d(2000, 1024, 0), batch_size=batch_size,
                            shuffle=False, num_workers=2)
    net = Net2d()
